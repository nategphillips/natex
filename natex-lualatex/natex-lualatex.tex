...
\begin{tabular}{llll}
    ...
    \verb|\tr|  & \verb|\tr{A}|                    & $\tr{A}$                    & trace                \\
    \verb|\adj| & \verb|\adj{A}|                   & $\adj{A}$                   & adjugate             \\
    \verb|\tp|  & \verb|A^\tp|                     & $A^\tp$                     & transpose            \\
    \verb|\cc|  & \verb|A^\cc|                     & $A^\cc$                     & complex conjugate    \\
    \verb|\hc|  & \verb|A^\hc|                     & $A^\hc$                     & Hermitian conjugate  \\
\end{tabular}
