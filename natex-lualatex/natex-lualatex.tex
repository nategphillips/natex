...
\usepackage{natex-lualatex, xcolor, pagecolor}
...
\title{The \texttt{natex-lualatex} package}
...
This package requires the \verb|fontsetup|, \verb|mathtools|, and \verb|unicode-math| packages.
