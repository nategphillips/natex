...
\begin{tabular}{llll}
    ...
    \verb|\integers|  & \verb|\integers|      & $\integers$      & set of integers         \\
    \verb|\rationals| & \verb|\rationals|     & $\rationals$     & set of rational numbers \\
    \verb|\reals|     & \verb|\reals|         & $\reals$         & set of real numbers     \\
    \verb|\complexes| & \verb|\complexes|     & $\complexes$     & set of complex numbers  \\
    \verb|\set|       & \verb=\set{a | b, c}= & $\set{a | b, c}$ & set builder notation    \\
\end{tabular}
